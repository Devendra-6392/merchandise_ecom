...
export const metadata: Metadata = {
  ...
  description: "Minimalist Editorial with High-Contrast accents. Discover luxury streetwear, capsule collections, limited runs, and modern fashion curation.",
  keywords: ["Orangered Studio", "High Fashion", "Streetwear", "Luxury Apparel", "Capsule Collection", "Lookbook"],
};
