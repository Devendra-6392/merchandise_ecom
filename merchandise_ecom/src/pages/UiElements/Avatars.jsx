...
export default function Avatars() {
    return (<>
      <PageMeta title="React.js Avatars Dashboard | Merch Studio - React.js Admin Dashboard Template" description="This is React.js Avatars Dashboard page for Merch Studio - React.js Tailwind CSS Admin Dashboard Template"/>
