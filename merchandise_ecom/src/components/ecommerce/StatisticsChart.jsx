...
export default function StatisticsChart() {
    ...
    const options = {
        ...
        colors: ["#FF5424", "#FF9275"], // Define line colors
        chart: {
    ...
    return (<div className="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-3 sm:justify-end">
          ...
          <div className="relative inline-flex items-center">
            ...
            <input ref={datePickerRef} className="h-10 w-10 lg:w-40 lg:h-auto  lg:pl-10 lg:pr-3 lg:py-2 rounded-lg border border-gray-200 bg-white text-sm font-medium text-transparent lg:text-gray-700 outline-none dark:border-gray-700 dark:bg-gray-800 dark:lg:text-gray-300 cursor-pointer" placeholder="Select date range"/>
          </div>
        </div>
      </div>
